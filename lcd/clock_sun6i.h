...
#define CONFIG_MACH_SUN8I
#define CONFIG_MACH_SUN8I_V3S
#define __ASSEMBLY__

struct sunxi_ccm_reg {
	unsigned int pll1_cfg;		/* 0x00 pll1 control */
	unsigned int reserved0;
	unsigned int pll2_cfg;		/* 0x08 pll2 control */
	unsigned int reserved1;
	unsigned int pll3_cfg;		/* 0x10 pll3 control */
	unsigned int reserved2;
	unsigned int pll4_cfg;		/* 0x18 pll4 control */
	unsigned int reserved3;
	unsigned int pll5_cfg;		/* 0x20 pll5 control */
	unsigned int reserved4;
	unsigned int pll6_cfg;		/* 0x28 pll6 control */
	unsigned int reserved5;
	unsigned int pll7_cfg;		/* 0x30 pll7 control */
	unsigned int reserved6;
	unsigned int pll8_cfg;		/* 0x38 pll8 control */
	unsigned int reserved7;
	unsigned int mipi_pll_cfg;	/* 0x40 MIPI pll control */
	unsigned int pll9_cfg;		/* 0x44 pll9 control */
	unsigned int pll10_cfg;		/* 0x48 pll10 control */
	unsigned int pll11_cfg;		/* 0x4c pll11 (ddr1) control (A33 only) */
	unsigned int cpu_axi_cfg;	/* 0x50 CPU/AXI divide ratio */
	unsigned int ahb1_apb1_div;	/* 0x54 AHB1/APB1 divide ratio */
	unsigned int apb2_div;		/* 0x58 APB2 divide ratio */
	unsigned int axi_gate;		/* 0x5c axi module clock gating */
	unsigned int ahb_gate0;		/* 0x60 ahb module clock gating 0 */
	unsigned int ahb_gate1;		/* 0x64 ahb module clock gating 1 */
	unsigned int apb1_gate;		/* 0x68 apb1 module clock gating */
	unsigned int apb2_gate;		/* 0x6c apb2 module clock gating */
	unsigned int bus_gate4;          /* 0x70 gate 4 module clock gating */
	unsigned char res3[0xc];
	unsigned int nand0_clk_cfg;	/* 0x80 nand0 clock control */
	unsigned int nand1_clk_cfg;	/* 0x84 nand1 clock control */
	unsigned int sd0_clk_cfg;	/* 0x88 sd0 clock control */
	unsigned int sd1_clk_cfg;	/* 0x8c sd1 clock control */
	unsigned int sd2_clk_cfg;	/* 0x90 sd2 clock control */
	unsigned int sd3_clk_cfg;	/* 0x94 sd3 clock control */
	unsigned int ts_clk_cfg;		/* 0x98 transport stream clock control */
	unsigned int ss_clk_cfg;		/* 0x9c security system clock control */
	unsigned int spi0_clk_cfg;	/* 0xa0 spi0 clock control */
	unsigned int spi1_clk_cfg;	/* 0xa4 spi1 clock control */
	unsigned int spi2_clk_cfg;	/* 0xa8 spi2 clock control */
	unsigned int spi3_clk_cfg;	/* 0xac spi3 clock control */
	unsigned int i2s0_clk_cfg;	/* 0xb0 I2S0 clock control*/
	unsigned int i2s1_clk_cfg;	/* 0xb4 I2S1 clock control */
	unsigned int reserved10[2];
	unsigned int spdif_clk_cfg;	/* 0xc0 SPDIF clock control */
	unsigned int reserved11[2];
	unsigned int usb_clk_cfg;	/* 0xcc USB clock control */
	unsigned int gmac_clk_cfg;	/* 0xd0 GMAC clock control */
	unsigned int reserved12[7];
	unsigned int mdfs_clk_cfg;	/* 0xf0 MDFS clock control */
	unsigned int dram_clk_cfg;	/* 0xf4 DRAM configuration clock control */
	unsigned int dram_pll_cfg;	/* 0xf8 PLL_DDR cfg register, A33 only */
	unsigned int mbus_reset;		/* 0xfc MBUS reset control, A33 only */
	unsigned int dram_clk_gate;	/* 0x100 DRAM module gating */
#ifdef CONFIG_SUNXI_DE2
	unsigned int de_clk_cfg;		/* 0x104 DE module clock */
#else
	unsigned int be0_clk_cfg;	/* 0x104 BE0 module clock */
#endif
	unsigned int be1_clk_cfg;	/* 0x108 BE1 module clock */
	unsigned int fe0_clk_cfg;	/* 0x10c FE0 module clock */
	unsigned int fe1_clk_cfg;	/* 0x110 FE1 module clock */
	unsigned int mp_clk_cfg;		/* 0x114 MP module clock */
	unsigned int lcd0_ch0_clk_cfg;	/* 0x118 LCD0 CH0 module clock */
	unsigned int lcd1_ch0_clk_cfg;	/* 0x11c LCD1 CH0 module clock */
	unsigned int reserved14[3];
	unsigned int lcd0_ch1_clk_cfg;	/* 0x12c LCD0 CH1 module clock */
	unsigned int lcd1_ch1_clk_cfg;	/* 0x130 LCD1 CH1 module clock */
	unsigned int csi0_clk_cfg;	/* 0x134 CSI0 module clock */
	unsigned int csi1_clk_cfg;	/* 0x138 CSI1 module clock */
	unsigned int ve_clk_cfg;		/* 0x13c VE module clock */
	unsigned int adda_clk_cfg;	/* 0x140 ADDA module clock */
	unsigned int avs_clk_cfg;	/* 0x144 AVS module clock */
	unsigned int dmic_clk_cfg;	/* 0x148 Digital Mic module clock*/
	unsigned int reserved15;
	unsigned int hdmi_clk_cfg;	/* 0x150 HDMI module clock */
#ifdef CONFIG_SUNXI_DE2
	unsigned int hdmi_slow_clk_cfg;	/* 0x154 HDMI slow module clock */
#else
	unsigned int ps_clk_cfg;		/* 0x154 PS module clock */
#endif
	unsigned int mtc_clk_cfg;	/* 0x158 MTC module clock */
	unsigned int mbus0_clk_cfg;	/* 0x15c MBUS0 module clock */
	unsigned int mbus1_clk_cfg;	/* 0x160 MBUS1 module clock */
	unsigned int reserved16;
	unsigned int mipi_dsi_clk_cfg;	/* 0x168 MIPI DSI clock control */
	unsigned int mipi_csi_clk_cfg;	/* 0x16c MIPI CSI clock control */
	unsigned int reserved17[4];
	unsigned int iep_drc0_clk_cfg;	/* 0x180 IEP DRC0 module clock */
	unsigned int iep_drc1_clk_cfg;	/* 0x184 IEP DRC1 module clock */
	unsigned int iep_deu0_clk_cfg;	/* 0x188 IEP DEU0 module clock */
	unsigned int iep_deu1_clk_cfg;	/* 0x18c IEP DEU1 module clock */
	unsigned int reserved18[4];
	unsigned int gpu_core_clk_cfg;	/* 0x1a0 GPU core clock config */
	unsigned int gpu_mem_clk_cfg;	/* 0x1a4 GPU memory clock config */
	unsigned int gpu_hyd_clk_cfg;	/* 0x1a0 GPU HYD clock config */
	unsigned int reserved19[21];
	unsigned int pll_lock;		/* 0x200 PLL Lock Time */
	unsigned int pll1_lock;		/* 0x204 PLL1 Lock Time */
	unsigned int reserved20[6];
	unsigned int pll1_bias_cfg;	/* 0x220 PLL1 Bias config */
	unsigned int pll2_bias_cfg;	/* 0x224 PLL2 Bias config */
	unsigned int pll3_bias_cfg;	/* 0x228 PLL3 Bias config */
	unsigned int pll4_bias_cfg;	/* 0x22c PLL4 Bias config */
	unsigned int pll5_bias_cfg;	/* 0x230 PLL5 Bias config */
	unsigned int pll6_bias_cfg;	/* 0x234 PLL6 Bias config */
	unsigned int pll7_bias_cfg;	/* 0x238 PLL7 Bias config */
	unsigned int pll8_bias_cfg;	/* 0x23c PLL8 Bias config */
	unsigned int mipi_bias_cfg;	/* 0x240 MIPI Bias config */
	unsigned int pll9_bias_cfg;	/* 0x244 PLL9 Bias config */
	unsigned int pll10_bias_cfg;	/* 0x248 PLL10 Bias config */
	unsigned int reserved21[5];
	unsigned int pll5_tuning_cfg;	/* 0x260 PLL5 Tuning config */
	unsigned int reserved21_5[7];
	unsigned int pll1_pattern_cfg;	/* 0x280 PLL1 Pattern config */
	unsigned int pll2_pattern_cfg;	/* 0x284 PLL2 Pattern config */
	unsigned int pll3_pattern_cfg;	/* 0x288 PLL3 Pattern config */
	unsigned int pll4_pattern_cfg;	/* 0x28c PLL4 Pattern config */
	unsigned int pll5_pattern_cfg;	/* 0x290 PLL5 Pattern config */
	unsigned int pll6_pattern_cfg;	/* 0x294 PLL6 Pattern config */
	unsigned int pll7_pattern_cfg;	/* 0x298 PLL7 Pattern config */
	unsigned int pll8_pattern_cfg;	/* 0x29c PLL8 Pattern config */
	unsigned int mipi_pattern_cfg;	/* 0x2a0 MIPI Pattern config */
	unsigned int pll9_pattern_cfg;	/* 0x2a4 PLL9 Pattern config */
	unsigned int pll10_pattern_cfg;	/* 0x2a8 PLL10 Pattern config */
	unsigned int pll11_pattern_cfg0; /* 0x2ac PLL11 Pattern config0, A33 only */
	unsigned int pll11_pattern_cfg1; /* 0x2b0 PLL11 Pattern config0, A33 only */
	unsigned int reserved22[3];
	unsigned int ahb_reset0_cfg;	/* 0x2c0 AHB1 Reset 0 config */
	unsigned int ahb_reset1_cfg;	/* 0x2c4 AHB1 Reset 1 config */
	unsigned int ahb_reset2_cfg;	/* 0x2c8 AHB1 Reset 2 config */
	unsigned int reserved23;
	unsigned int apb1_reset_cfg;	/* 0x2d0 APB1 Reset config */
	unsigned int reserved24;
	unsigned int apb2_reset_cfg;	/* 0x2d8 APB2 Reset config */
	unsigned int reserved25[5];
	unsigned int ccu_sec_switch;	/* 0x2f0 CCU Security Switch, H3 only */
};
